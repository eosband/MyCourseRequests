// Drop Down selector class from: https://github.com/jriosdev/iOSDropDown/blob/master/iOSDropDown/Classes/iOSDropDown.swift
// Only used for selecting 30, 45, or 60 minutes for a music lesson
...
open class DropDown : UITextField{
    ...
    @IBInspectable public var selectedRowColor: UIColor = UIColor(red: 14, green: 77, blue: 146, alpha: 1)
